    ...
    <section id="login">
        <div class="row align-items-center h-100 m-0">
            ...
            <div class="col-md-8 ms-auto">
                ...
                <h3 class="text-center fw-500 text-orange ">User <span class="text-dark">login</span></h3>
                ...
                <form role="form" method="POST" action="{{ route('user.login.check') }}">
                    ...
                    <div class="row">
                        ...
                        <div class="col-6 mb-3">
                            <a href="{{ route('user.registration') }}" class="text-dark text-decoration-none">Dont have
