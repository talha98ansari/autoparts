                ...
                <div class="col-lg-6 col-7">
                    ...
                    <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                        <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                            ...
                            <li class="breadcrumb-item"><a href="{{route('follow.index')}}">Social Links</a></li>
...
<div class="container-fluid mt--7">
    ...
    <div class="col-md-9 order-xl-1">
        <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
                <form method="post" action="{{ route('follow.up' , $data->id) }}" autocomplete="off"
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="form-group {{ $errors->has('name') ? ' has-danger' : '' }} col-md-9">
                            ...
                            <input type="text" name="name" id="input-name"
                                ...
                                placeholder="{{ __('Name') }}" value="{{ old('name') ?? $data->name}}" required readonly autofocus>
                        ...
                        <div class="form-group {{ $errors->has('link') ? ' has-danger' : '' }} col-md-9">
                            ...
                            <input type="text" name="link" id="input-link"
                                ...
                                placeholder="{{ __('link') }}" value="{{ old('link') ?? $data->link }}" required autofocus>
