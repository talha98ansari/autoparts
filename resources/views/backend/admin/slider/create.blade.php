                ...
                <form method="post" action="{{ route('slider.store') }}" autocomplete="off"
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="form-group {{ $errors->has('heading') ? ' has-danger' : '' }} col-md-9">
                            ...
                            <input type="text" name="heading" id="input-heading"
                            ...
                            <input type="text" name="sub_heading" id="input-sub_heading"
                            ...
                            <textarea type="text" name="content" id="input-content"
                                class="form-control form-control-alternative" placeholder="{{ __('content') }}"></textarea>
