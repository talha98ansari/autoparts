        ...
        <div class="header-body">
            <div class="row align-items-center py-4">
                <div class="col-lg-6 col-7">
                    <h6 class="h2 text-white d-inline-block mb-0">Add new Service</h6>
                    ...
                    <div class="pl-lg-4">
                        ...
                        <div class="form-group {{ $errors->has('cat_id') ? ' has-danger' : '' }} col-md-9">
                            <label class="form-control-label"
                                for="input-cat_id">{{ __('Select Category') }}</label>
                            <select name="cat_id" id="input-cat_id"
                                class="categroy_dropdown form-control form-control-alternative{{ $errors->has('cat_id') ? ' is-invalid' : '' }}"
                                placeholder="{{ __('category') }}" required autofocus>
